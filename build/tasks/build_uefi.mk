...
$(FIP_BIN): $(FIP_DEP)
	...
	echo "## OPTEE_PLATFORM_FLAVOR = $(OPTEE_PLATFORM_FLAVOR)"
	...
	PATH=$(HOST_PATH):$$PATH $(HOST_MAKE) -j1 -C $(BOOTLOADER_DIR) TOP_ROOT_ABS=$(TOP_ROOT_ABS) OPTEE_PLATFORM_FLAVOR=$(OPTEE_PLATFORM_FLAVOR) CLANG_PATH=$(CLANG_PATH)
